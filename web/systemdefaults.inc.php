...
// $db_port = 1234;
// Database name:
$db_database = "assessze_mrbs";
// Schema name.  This only applies to PostgreSQL and is only necessary if you have more
// than one schema in your database and also you are using the same MRBS table names in
// multiple schemas.
//$db_schema = "public";
// Database login user name:
$db_login = "assessze_syed";
// Database login password:
$db_password = 'Blusurge2015';
 ...
 *********************************/
$mrbs_admin = "Syed Admin(Blusurge)";
$mrbs_admin_email = "syed@blusurge.com";
...
// email addresses in the format 'Full Name <address>', for example:
 $mrbs_admin_email = 'Booking System <syed@blusurge>';
// if the name section has any "peculiar" characters in it, you will need
// to put the name in double quotes, e.g.:
 $mrbs_admin_email = '"Syed, Farhan" <syed@blusurge>';

// The company name is mandatory.   It is used in the header and also for email notifications.
// The company logo, additional information and URL are all optional.

$mrbs_company = "Blusurge";   // This line must always be uncommented ($mrbs_company is used in various places)
...
//$mrbs_company_more_info = "Your partner for nextgenIT";  // e.g. "XYZ Department"
...
$auth["admin"][] = "localhost";     // localhost IP address. Useful with IP sessions.
...
// required values as appropriate.
 $pwd_policy['length']  = 5;  // Minimum length
...
// tells the system to use Unix Domain Sockets, and $db_port will be ignored;
// if you want to force TCP connection you can use "127.0.0.1".
$auth['db_ext']['db_host'] = '64.37.59.194';
// If you need to use a non standard port for the database connection you
// can uncomment the following line and specify the port number
...
$auth["imap_php"]["hostname"] = "64.37.59.194";
...
$mail_settings['domain'] = 'syed@blusurge.com';
...
$mail_settings['username_suffix'] = 'Syed';
...
$smtp_settings['host'] = '64.37.59.194';  // SMTP server
...
$mail_settings['from'] = "info@blusurge.com,syed@blusurge.com";
...
// as the recipient's.
$mail_settings['organizer'] = 'syed@blusurge.com';

// Set the recipient email. Default is 'admin_email@your.org'. You can define
// more than one recipient like this "john@doe.com,scott@tiger.com"
$mail_settings['recipients'] = 'ram@blusurge.com';

// Set email address of the Carbon Copy field. Default is ''. You can define
// more than one recipient (see 'recipients')
$mail_settings['cc'] = 'ram@blusurge.com';
