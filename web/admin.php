...
else
{
  ...
  else
  {
    ...
    // The area selector
    echo "<label id=\"area_label\" for=\"area_select\">" . get_vocab("Building ") . ":</label>\n";
...
if ($is_admin)
{
  ...
  <form id="add_area" class="form_admin" action="add.php" method="post">
    <fieldset>
    <legend><?php echo get_vocab("Add Building ") ?></legend>
      ...
      <div>
        <input type="submit" class="submit" value="<?php echo get_vocab("Add Building") ?>">
      </div>
